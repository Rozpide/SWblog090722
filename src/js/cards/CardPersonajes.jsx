    ...
    return (
        <div className="col-md-3 my-4 ">
            <div className="card border-0">
                <img src={"https://starwars-visualguide.com/assets/img/characters/"+ props.personaje.uid+".jpg" } id="fotoHeaderCard" className="card-img-top" />
                ...
                <div className="card-footer">
                    <Link to={`/personaje/${props.personaje.url.replace("http://swapi.tech/api/people/", "").replace("/", "")}`} className="btn btn-outline-primary" personaje={props}>Learn More!</Link>
